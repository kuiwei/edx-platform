...
from student.models import (
    Registration, UserProfile, PendingNameChange, RoleUser, TRole,
...
def login_user(request, error=""):  # pylint: disable-msg=too-many-statements,unused-argument
    ...
    if third_party_auth_requested and not trumped_by_first_party_auth:
        ...
        try:
            ...
            roleuser = TRole.objects.get(id=role.roleId)
    ...
    if send_email:
        ...
        try:
            if settings.FEATURES.get('REROUTE_ACTIVATION_EMAIL'):
                ...
                index = sendemail(subject, message, from_address, post_vars['email'])
                if index:
                    print "success"
...
def reactivation_email_for_user(user):
    ...
    try:
        ...
        index = sendemail(subject, message, settings.DEFAULT_FROM_EMAIL, detail.email)
        if index:
            print "successs"
