...
class CourseFields(object):
   ...
   #nicky added here
    ...
    course_introduce = Boolean(
        help=_('Enter true or false. when True:the course has been introduced course.'),
        default=False,
    ...
    course_video = String(
        ...
        help=_("Edit the name of the course video file. You must upload this file on the Files & Uploads page."),
        scope=Scope.settings,
...
class CourseDescriptor(CourseFields, SequenceDescriptor):
    ...
    def introduce_course(self):
        if self.course_introduce:
            return self.course_introduce
        return False

    @property
    def set_introduce_course(self):
        if self.introduce_course == False:
            self.introduce_course = True

        return self.introduce_course
