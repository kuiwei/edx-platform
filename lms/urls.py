...
for key, value in settings.MKTG_URL_LINK_MAP.items():
    ...
    if key == "ROOT" or key == "COURSES" or key=="SCHOOLS":
        continue
...
if settings.SCHOOL_ENABLED:
    urlpatterns += (
        url(r'^schools/?$', 'colleges.views.colleges', name="schools"),
        url(r'^schools/{}/about$'.format(settings.SCHOOL_NAME_PATTERN),
            'colleges.views.jump_to', name="about_school"),
...
if settings.COURSEWARE_ENABLED:
    urlpatterns += (
        ...
        #About the course_kinds
        url(r'^knowledge/{}/about$'.format(settings.COURSE_KIND_PATTERN),
            'courseware.views.course_kinds_about', name="about_kinds"),
